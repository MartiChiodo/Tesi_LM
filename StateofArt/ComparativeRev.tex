...
L'approccio di soluzione è un'euristica basata sulla generazione di colonne e si sviluppa in 3 fasi: (1) raggruppamento degli ordini in batch tramite generazione di colonne, (2) sequenziamento dei batch per minimizzare i cambi di variabili, questo problema è formulato come commesso viaggiatore, e (3) raffinamento della soluzione.
